...
export const LOCATIONS = [
  {
    ...
    // ✅ NEW: ServiceSections (SEO headings that match real queries)
    serviceSections: [
      {
        ...
        bullets: [
          ...
          "User support for common day-to-day issues",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Root-cause fixes (not just temporary patches)",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Endpoint protection and patching baselines",
          "Security reviews and priority gap fixes",
          "Ongoing monitoring to reduce risk and downtime",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          "Disaster recovery steps and priorities",
...

  {
    ...
    copy: {
      paragraphs: [
        "Macungie teams often want one thing most: predictable IT. When support is purely reactive, small issues turn into recurring interruptions—slow devices, access problems, Wi-Fi instability, and Microsoft 365 headaches. Our managed IT services for Macungie are designed around fast helpdesk support plus proactive monitoring and patching that reduces downtime.",
    ...
    serviceSections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "User access and Microsoft 365 help",
      ...
      },
      {
        ...
        title: "Device Management (MDM) & IT Strategy",
        sub: "MDM control + vCIO planning for growing teams.",
        href: "/services/vcio-it-strategy",
        text:
        ...
        bullets: [
          ...
          "Quarterly planning and roadmap support",
    ...
    serviceSections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Quarterly roadmap and planning support",
          "Budget/vendor alignment and priorities",
        ],
      },
    ],
