...
export const site = {
  ...
  tagline:
    "Managed IT Services in Allentown, Macungie & Emmaus — Fast, Friendly, Fixed-Fee",
bookingUrl: "https://calendly.com/your-link/15min",
  ...
  // ✅ Contact
  email: "supremeitexperts@gmail.com",
  phone: "+1 610-500-9209",

  // (Keep if used elsewhere; Home CTA block does not show WhatsApp now)
  whatsapp: "+1 610-500-9209",
