...
// ✅ Keep UK links in code, but hide when rollout is OFF
const UK_LINKS = [
  { href: "/uk", label: "Home" },
...
function isUkRolloutOn() {
  const v = String(process.env.NEXT_PUBLIC_UK_ROLLOUT || "")
    .toLowerCase()
    .trim();
